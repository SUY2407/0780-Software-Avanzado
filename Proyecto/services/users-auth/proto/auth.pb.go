...
type GetUserByIdResponse struct {
	...
	Nit           string                 `protobuf:"bytes,5,opt,name=nit,proto3" json:"nit,omitempty"`
...
func (x *GetUserByIdResponse) GetNit() string {
	if x != nil {
		return x.Nit
	}
	return ""
...
const file_proto_auth_proto_rawDesc = "" +
	...
	"\auser_id\x18\x01 \x01(\x05R\x06userId\"\xb3\x01\n" +
	...
	"\x03nit\x18\x05 \x01(\tR\x03nit\x12\x14\n" +
	"\x05phone\x18\x06 \x01(\tR\x05phone\x12\x12\n" +
	"\x04role\x18\a \x01(\tR\x04role2\x9b\x01\n" +
	"\vAuthService\x12H\n" +
	"\rValidateToken\x12\x1a.auth.ValidateTokenRequest\x1a\x1b.auth.ValidateTokenResponse\x12B\n" +
	"\vGetUserById\x12\x18.auth.GetUserByIdRequest\x1a\x19.auth.GetUserByIdResponseB\rZ\v/proto;authb\x06proto3"
